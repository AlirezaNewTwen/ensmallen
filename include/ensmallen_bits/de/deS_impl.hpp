 ...
 */
#ifndef ENSMALLEN_DES_DES_IMPL_HPP
#define ENSMALLEN_DES_DES_IMPL_HPP

#include "deS.hpp"

namespace ens {

inline DES::DES(const size_t populationSize ,
...
typename MatType::elem_type DES::Optimize(FunctionType& function,
                                         MatType& iterateIn,
                                         CallbackTypes&&... callbacks)
{
  ...
  for (size_t gen = 0; gen < maxGenerations && !terminate; gen++)
  {
    ...
    {
      Info << "DES: minimized within tolerance " << tolerance << "; "
