/**
 * @file deS.hpp
 * @author Rahul Ganesh Prabhu Developed by ALireza for SHADE
 *
...
#ifndef ENSMALLEN_DES_DES_HPP
#define ENSMALLEN_DES_DES_HPP
...
class DES
{
 public:
  /**
   * Constructor for the DES optimizer
   *
   ...
   */
  DES(const size_t populationSize = 100,
